                ...
                <div class="card-body">
                    ...
                    <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                        ...
                        <tr>
                            ...
                            <td><img src="{{asset($category->image)}}" alt="" height="50" width="75"></td>
                            <td>{{$category->status == 1 ? 'Published' : 'Unpublished'}}</td>
                            <td>
                                <a href="{{route('category.status',['id'=>$category->id])}}" class="btn btn-{{$category->status == 1 ? 'success' : 'warning'}} btn-sm" title="Published/unpublished Category">
