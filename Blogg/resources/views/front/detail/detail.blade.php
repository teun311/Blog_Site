                ...
                <div class="col-lg-8 py-100">
                    <div class="border rounded bg-white">
                        ...
                        <div class="p-4">
                            ...
                            <ul class="list-inline d-block pb-4 border-bottom mb-3">
                                <li class="list-inline-item text-color">Posted By :{{$blog->author->name}}</li>
                                <li class="list-inline-item text-color">{{date('d M Y',strtotime($blog->created_at))}}</li>
                                <li class="list-inline-item text-color">Category: {{$blog->category->name}}</li>
                            </ul>
                    ...
                    <div>
                        ...
                        <div class="d-flex mb-4">
                            <div class="mr-3">
                                <img class="img-fluid rounded w-100" src="{{asset('/')}}front/images/blog/comment-1.jpg" alt="user-image">
                            </div>
                        ...
                        <div class="d-flex mb-4">
                            <div class="mr-3">
                                <img class="img-fluid rounded w-100" src="images/blog/comment-2.jpg" alt="user-image">
                            </div>
                            <div class="border rounded py-3 px-4">
                                <div class="border-bottom mb-10">
                                    <h5>Mikymouse</h5>
